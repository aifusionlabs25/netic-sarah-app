...
export default function InteractiveAvatar() {
    ...
    const [audioOnly] = useState(false);
                                ...
                                <div className="h-full w-full bg-white">
                                    <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200">
                                        <div className="flex items-center gap-2 text-slate-700">
                                            ...
                                            <span className="ml-3 text-sm font-semibold">Netic.ai Interactive Demo</span>
                                        </div>
                                    ...
                                    >
                                        {/* Placeholder Demo URL - Sarah Specific */}
                                        <iframe
                                            src="https://netic.ai/demo/"
                                            className="h-full w-full border-0"
                                            title="Netic Interactive Demo"
                                        />
                                    </div>
                                </div>
                            </section>
                            ...
                            >
                                <div className="flex h-[72px] items-center justify-between px-5">
                                    <div className="gd-badge">
                                        ...
                                        <span className="text-sm font-semibold">Sarah live</span>
                                    </div>

                                    <button onClick={handleEndDemo} className="gd-btn" type="button" title="Back to Sarah">
                                        <span>Back</span>
                                    </button>
                                </div>
                    ...
                    {!showDemo && (
                        ...
                        */}
                                        ...
                                        <h1 className="text-balance text-4xl md:text-5xl font-light tracking-tight">
                                            Meet <span className="gd-gradient-text font-semibold">Sarah</span>
                                        </h1>
                                        <p className="mt-4 max-w-xl text-lg text-slate-300/90 leading-relaxed">
                                            Your Netic.ai Field Service Specialist.
                                        </p>
                                        ...
                                        <p className="mt-10 text-xs text-slate-400/90">
                                            Sarah uses AI to generate responses. Information may be inaccurate or incomplete. Please review and verify.
                                        </p>
                                    </div>
                                )}
                            </div>
